...
/*				if (Slew > Thresh){	//Spin in place, if Slew is positive (Thumbstick pushed right), spin right, new bracket L2
					...
					Left = Sensitivity * Slew  * .5;					//Left partial reverse, tempered by thumbstick
					Right = Sensitivity * Slew * -1 * .5;				//Right partial forward, tempered by thumbstick
