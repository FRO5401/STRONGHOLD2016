...
const double RoughTerrainAutoDriveSpeed	= 0.85; //.4 for inital lowbar
...
AutonomousRoughTerrain::AutonomousRoughTerrain(int DefensePosition, int GoalPosition, int LowOrHigh)
{
	...
	AddSequential(new AutoDriveCommand(-140, RoughTerrainAutoDriveSpeed, 15));//TODO Physically determine distance
	// Add Commands here:
